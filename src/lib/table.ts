...
export const colorOf = (kelompok) => {
  const lookup = {
    ...
    "Black Sea": { color: "black", background: "white" },
    ...
    "Antartic Ocean": { color: "black", background: "#d97706" },
    "Hudson Bay": { color: "black", background: "#06b6d4" },
    "Labrador Sea": { color: "black", background: "7c2d12" },
